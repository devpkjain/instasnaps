...
/**
 * Material ProgressBar Implementation courtesy of Antoine Merle
 * Via https://gist.github.com/castorflex/4e46a9dc2c3a4245a28e
 */
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private Property<CircularProgressDrawable, Float> mAngleProperty = new Property<CircularProgressDrawable, Float>(Float.class, "angle") {
        @Override public Float get(CircularProgressDrawable object) {
            return object.getCurrentGlobalAngle();
        }

        @Override public void set(CircularProgressDrawable object, Float value) {
